            ...
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                        {/* VK Icon */}
                        <img src={assets.vkIcon} alt="vk-icon" className='w-6' />
                        {/* Telegram Icon */}
                        <img src={assets.telegramIcon} alt="telegram-icon" className='w-6' />
                        {/* Max Messenger Icon */}
                        <img src={assets.maxMessenger} alt="max messenger-icon" className='w-6' />
