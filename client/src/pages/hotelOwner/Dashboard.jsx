  ...
  return (
    <div>
      ...
      <div className='flex gap-4 my-8'>
        {/* ---- ---Total Bookings-- */}
        <div className='bg-primaty/3 border border-primary/10 rounded flex p-4 pr-8'>
           <img src={assets.totalBookingIcon} alt="" 
           className='max-sm:hidden h-10'/>
           <div className='flex flex-col sm:ml-4 font-medium'>
             <p className='text-blue-500 text-lg'>Total Bookings</p>
             <p className='text-neutral-400 text-base'>{dashboardDate.totalBookings}</p>   
            </div>         
        </div>
        {/* ---- ---Total Revenue-- */}
        <div className='bg-primaty/3 border border-primary/10 rounded flex p-4 pr-8'>
           ...
           <div className='flex flex-col sm:ml-4 font-medium'>
             ...
             <p className='text-neutral-400 text-base'>₽ {dashboardDate.totalRevenue}</p>   
            </div>         
        </div>
      </div>
